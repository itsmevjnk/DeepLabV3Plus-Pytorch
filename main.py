...
from datasets import VOCSegmentation, Cityscapes, DexYCB
...
def get_argparser():
    ...
    parser.add_argument("--dataset", type=str, default='voc',
                        choices=['voc', 'cityscapes', 'dexycb'], help='Name of dataset')
...
def get_dataset(opts):
    ...
    if opts.dataset == 'dexycb':
        train_transform = et.ExtCompose([
            ...
            et.ExtNormalize(mean=[0.485, 0.456, 0.406],
                            std=[0.229, 0.224, 0.225]),
        ]) # NOTE: do we want to use a different train transform (esp. for augmentation)?
...
def main():
    ...
    if opts.dataset.lower() == 'voc':
        ...
        opts.num_classes = 19
    elif opts.dataset.lower() == 'dexycb':
        opts.num_classes = 23 # including background
